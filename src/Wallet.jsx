...
const Wallet = ({ close }) => {
  return (
    <div className="bg-[#FFFFFF] w-[335px] h-[326px] rounded-2xl absolute left-[20px] top-[340px] ">
        <div className="border-b border-solid border-[#CFD8DC] h-[50px]">
            <h4 className="w-[182px] h-[30px] ml-[18px] mt-[24px] font-red font-bold text-xl leading-[30px] text-[#333333]">Connect Wallet</h4>
            <img onClick={close} className="absolute left-[290px] top-[27px]" src={x} alt="x icon"/>
        </div>
        <p className="font-red font-normal text-base leading-5 text-[#333333] ml-[18px] mt-[32px]">Choose your preferred wallet:</p>
        <div className="w-[299px] h-[68px] rounded-xl bg-[#F8F9FA] border border-solid border-[#CFD8DC] ml-[18px] mt-[16px]">
            <div className="flex">
            ...
            <img className="absolute left-[300px] top-[170px]" src={arrow} alt="arrow icon"/>
        </div>
        <div className="w-[299px] h-[68px] rounded-xl bg-[#F8F9FA] border border-solid border-[#CFD8DC] ml-[18px] mt-[16px]">
            <div className="flex">
            ...
            <img className="absolute left-[300px] top-[250px]" src={arrow} alt="arrow icon"/>
        </div>
    </div>
