  ...
  return (
    ...
    <section className="flex flex-col ">
      <div className="mt-[162.13px]">
        <p className="font-red font-normal text-[40px] leading-[140%] tracking-[-0.02em] text-[#434343] ml-[5px]">
        ...
        <p className="font-red font-normal text-sm leading-[35px] text-[#434343] mt-[48px] ml-[5px]">we provide you access to luxury and affordable houses <br/> in the metaverse, get a chance to turn your <br /> imagination to reality at your comfort zone
        </p>
        <div className="flex mt-[48.08px] ml-[5px]">
          <input 
          type="search"
          name="search"
          id="name"
          placeholder="    Search for location"
          className="w-[200px] h-[54px] rounded-tl-lg rounded-bl-lg box-border border-[1px] border-solid border-[#A3A3A3]"
          >
            </input>
          <button className="w-[100px] h-[54px] bg-[#A02279] rounded-tr-lg rounded-br-lg font-red font-normal text-base leading-[19px] text-center text-white">Search</button>
        </div>
      </div>
      <div className="flex flex-col w-[300px]  ml-[0px]  mt-[580px]">
          <img className="w-[180px] h-[176px] absolute top-[850px] ml-[5px]" src={home1} alt="home one"/>
          <img className="w-[180px] h-[176px] absolute top-[1034px] ml-[5px]" src={home2} alt="home two"/>
          <img className="w-[180px] h-[176px] absolute top-[780px] ml-[189px]" src={home3} alt="home three"/>
          <img className="w-[180px] h-[176px] absolute top-[964px] ml-[189px]" src={home4} alt="home four"/>
      </div>
    </section>
    </>
      // <>
